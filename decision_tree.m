function tree = decision_tree(X, y, depth, max_depth)
    ...
    tree.left = decision_tree(X(left_idx, :), y(left_idx), depth+1, max_depth);
    tree.right = decision_tree(X(right_idx, :), y(right_idx), depth+1, max_depth);
end
